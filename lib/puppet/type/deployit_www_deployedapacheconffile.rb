Puppet::Type.newtype(:deployit_www_deployedapacheconffile ) do

      # this type is generated with genres.rb
      # generated for deployit 3.8.5

      desc 'adds a deployit_www_deployedapacheconffile ci to a remote deployit server'

      ensurable do

        desc 'deployit deployit_www_deployedapacheconffile resource state'
      ...
      newparam(:id, :namevar => true) do
        desc 'deployit_www_deployedapacheconffile id (full path required)'
