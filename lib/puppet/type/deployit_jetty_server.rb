Puppet::Type.newtype(:deployit_jetty_server ) do
      ...
      desc 'adds a deployit_jetty_server ci to a remote deployit server'

      ensurable do

        desc 'deployit deployit_jetty_server resource state'
      ...
      newparam(:id, :namevar => true) do
        desc 'deployit_jetty_server id (full path required)'
