Puppet::Type.newtype(:deployit_jetty_securityrolemapping ) do

      # this type is generated with genres.rb
      # generated for deployit 3.8.5

      desc 'adds a deployit_jetty_securityrolemapping ci to a remote deployit server'

      ensurable do

        desc 'deployit deployit_jetty_securityrolemapping resource state'
      ...
      newparam(:id, :namevar => true) do
        desc 'deployit_jetty_securityrolemapping id (full path required)'
