Puppet::Type.newtype(:deployit_wls_datasource ) do

      # this type is generated with genres.rb
      # generated for deployit 3.8.5

      desc 'adds a deployit_wls_datasource ci to a remote deployit server'

      ensurable do

        desc 'deployit deployit_wls_datasource resource state'
      ...
      newparam(:id, :namevar => true) do
        desc 'deployit_wls_datasource id (full path required)'
      ...
      newproperty(:drivername) do
          ...
          validate do |value|
            unless value != 'unset'
              fail('drivername needs to be set')
            end
          end
