Puppet::Type.newtype(:deployit_was_sibtopicspacedestination ) do

      # this type is generated with genres.rb
      # generated for deployit 3.8.5

      desc 'adds a deployit_was_sibtopicspacedestination ci to a remote deployit server'

      ensurable do

        desc 'deployit deployit_was_sibtopicspacedestination resource state'
      ...
      newparam(:id, :namevar => true) do
        desc 'deployit_was_sibtopicspacedestination id (full path required)'
      ...
      [ "deployit_was_cell",  "deployit_core_directory", ].each {|c|
