Puppet::Type.newtype(:deployit_wls_server ) do

      # this type is generated with genres.rb
      # generated for deployit 3.8.5

      desc 'adds a deployit_wls_server ci to a remote deployit server'

      ensurable do

        desc 'deployit deployit_wls_server resource state'
      ...
      newparam(:id, :namevar => true) do
        desc 'deployit_wls_server id (full path required)'
      ...
      newproperty(:startcommand) do
          ...
          desc 'Managed server start command'
      ...
      newproperty(:stopcommand) do
          ...
          desc 'Managed server stop command'
