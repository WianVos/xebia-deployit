Puppet::Type.newtype(:deployit_jee_ear ) do

      # this type is generated with genres.rb
      # generated for deployit 3.8.5

      desc 'adds a deployit_jee_ear ci to a remote deployit server'

      ensurable do

        desc 'deployit deployit_jee_ear resource state'
      ...
      newparam(:id, :namevar => true) do
        desc 'deployit_jee_ear id (full path required)'
