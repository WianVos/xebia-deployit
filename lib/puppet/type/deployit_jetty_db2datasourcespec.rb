Puppet::Type.newtype(:deployit_jetty_db2datasourcespec ) do

      # this type is generated with genres.rb
      # generated for deployit 3.8.5

      desc 'adds a deployit_jetty_db2datasourcespec ci to a remote deployit server'

      ensurable do

        desc 'deployit deployit_jetty_db2datasourcespec resource state'
      ...
      newparam(:id, :namevar => true) do
        desc 'deployit_jetty_db2datasourcespec id (full path required)'
