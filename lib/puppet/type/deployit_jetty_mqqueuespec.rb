Puppet::Type.newtype(:deployit_jetty_mqqueuespec ) do

      # this type is generated with genres.rb
      # generated for deployit 3.8.5

      desc 'adds a deployit_jetty_mqqueuespec ci to a remote deployit server'

      ensurable do

        desc 'deployit deployit_jetty_mqqueuespec resource state'
      ...
      newparam(:id, :namevar => true) do
        desc 'deployit_jetty_mqqueuespec id (full path required)'
