Puppet::Type.newtype(:deployit_www_apachehttpdserver ) do

      # this type is generated with genres.rb
      # generated for deployit 3.8.5

      desc 'adds a deployit_www_apachehttpdserver ci to a remote deployit server'

      ensurable do

        desc 'deployit deployit_www_apachehttpdserver resource state'
      ...
      newparam(:id, :namevar => true) do
        desc 'deployit_www_apachehttpdserver id (full path required)'
      ...
      newproperty(:startcommand) do
          ...
          validate do |value|
            unless value != 'unset'
              fail('startcommand needs to be set')
            end
          end
      ...
      newproperty(:defaultdocumentroot) do
         
          desc 'Default Document Root'
          ...
          validate do |value|
            unless value != 'unset'
              fail('defaultdocumentroot needs to be set')
            end
          end
