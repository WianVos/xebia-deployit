Puppet::Type.newtype(:deployit_was_warmodule ) do

      # this type is generated with genres.rb
      # generated for deployit 3.8.5

      desc 'adds a deployit_was_warmodule ci to a remote deployit server'

      ensurable do

        desc 'deployit deployit_was_warmodule resource state'
      ...
      newparam(:id, :namevar => true) do
        desc 'deployit_was_warmodule id (full path required)'
      ...
      newproperty(:contextroot) do
          ...
          validate do |value|
            unless value != 'unset'
              fail('contextroot needs to be set')
            end
          end
        
      end
    
      newproperty(:webservers , :array_matching => :all) do
        def insync?(is)
      ...
      newproperty(:sharedlibraries , :array_matching => :all) do
        def insync?(is)
      ...
      newproperty(:rolemappings , :array_matching => :all) do
