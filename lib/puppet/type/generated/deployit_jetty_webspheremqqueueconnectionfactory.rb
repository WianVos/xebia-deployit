Puppet::Type.newtype(:deployit_jetty_webspheremqqueueconnectionfactory ) do

      # this type is generated with genres.rb
      # generated for deployit 3.8.5

      desc 'adds a deployit_jetty_webspheremqqueueconnectionfactory ci to a remote deployit server'

      ensurable do

        desc 'deployit deployit_jetty_webspheremqqueueconnectionfactory resource state'
      ...
      newparam(:id, :namevar => true) do
        desc 'deployit_jetty_webspheremqqueueconnectionfactory id (full path required)'
      ...
      newproperty(:queuemanager) do
          ...
          validate do |value|
            unless value != 'unset'
              fail('queuemanager needs to be set')
            end
          end
