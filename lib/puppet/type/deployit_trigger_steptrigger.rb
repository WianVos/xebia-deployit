Puppet::Type.newtype(:deployit_trigger_steptrigger ) do

      # this type is generated with genres.rb
      # generated for deployit 3.8.5

      desc 'adds a deployit_trigger_steptrigger ci to a remote deployit server'

      ensurable do

        desc 'deployit deployit_trigger_steptrigger resource state'
      ...
      newparam(:id, :namevar => true) do
        desc 'deployit_trigger_steptrigger id (full path required)'
