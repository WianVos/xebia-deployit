Puppet::Type.newtype(:deployit_www_apacheconffile ) do

      # this type is generated with genres.rb
      # generated for deployit 3.8.5

      desc 'adds a deployit_www_apacheconffile ci to a remote deployit server'

      ensurable do

        desc 'deployit deployit_www_apacheconffile resource state'
      ...
      newparam(:id, :namevar => true) do
        desc 'deployit_www_apacheconffile id (full path required)'
