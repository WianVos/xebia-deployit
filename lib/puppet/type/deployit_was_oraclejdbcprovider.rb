Puppet::Type.newtype(:deployit_was_oraclejdbcprovider ) do

      # this type is generated with genres.rb
      # generated for deployit 3.8.5

      desc 'adds a deployit_was_oraclejdbcprovider ci to a remote deployit server'

      ensurable do

        desc 'deployit deployit_was_oraclejdbcprovider resource state'
      ...
      newparam(:id, :namevar => true) do
        desc 'deployit_was_oraclejdbcprovider id (full path required)'
      ...
      newproperty(:implementationclassname) do
          ...
          defaultto ('oracle.jdbc.pool.OracleConnectionPoolDataSource') 
