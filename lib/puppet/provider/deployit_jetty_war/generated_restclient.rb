...
Puppet::Type.type(:deployit_jetty_war).provide(:generated_restclient, :parent => Puppet::Provider::General_restclient) do
    ...
    def self.properties
      ...
      [  "contextRoot",  "startingWeight",  "excludeFileNamesRegex",  ]
