...
Puppet::Type.type(:deployit_was_ear).provide(:generated_restclient, :parent => Puppet::Provider::General_restclient) do
    ...
    def self.properties
      ...
      [  "startingWeight",  "excludeFileNamesRegex",  "preCompileJsps",  ]
