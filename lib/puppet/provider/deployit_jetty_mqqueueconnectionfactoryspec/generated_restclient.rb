...
Puppet::Type.type(:deployit_jetty_mqqueueconnectionfactoryspec).provide(:generated_restclient, :parent => Puppet::Provider::General_restclient) do
    ...
    def self.deployit_type
      "jetty.MQQueueConnectionFactorySpec"
    end
