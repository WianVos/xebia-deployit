...
Puppet::Type.type(:deployit_wls_datasourcespec).provide(:generated_restclient, :parent => Puppet::Provider::General_restclient) do
    ...
    def self.properties
      ...
      [  "restartTarget",  "password",  "JDBCConnectionPoolParams_InitialCapacity",  "jndiNames",  "driverName",  "url",  "JDBCConnectionPoolParams_MaxCapacity",  "targetRestartPolicy",  "username",  "JDBCConnectionPoolParams_CapacityIncrement",  ]
