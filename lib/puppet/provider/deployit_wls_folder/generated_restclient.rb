...
Puppet::Type.type(:deployit_wls_folder).provide(:generated_restclient, :parent => Puppet::Provider::General_restclient) do
    ...
    def self.properties
      ...
      [  "targetDirectory",  "targetFile",  "restartTarget",  "createTargetDirectory",  "excludeFileNamesRegex",  "targetRestartPolicy",  "targetDirectoryShared",  ]
