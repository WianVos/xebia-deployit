...
Puppet::Type.type(:deployit_wls_uniformdistributedqueuespec).provide(:generated_restclient, :parent => Puppet::Provider::General_restclient) do
    ...
    def self.properties
      ...
      [  "jndiName",  "subDeploymentName",  "jmsModuleName",  "DeliveryFailureParams_RedeliveryLimit",  ]
