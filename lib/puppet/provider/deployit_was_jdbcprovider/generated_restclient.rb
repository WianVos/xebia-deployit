...
Puppet::Type.type(:deployit_was_jdbcprovider).provide(:generated_restclient, :parent => Puppet::Provider::General_restclient) do
    ...
    def self.properties
      ...
      [  "classpath",  "providerType",  "description",  "nativepath",  "implementationClassName",  ]
