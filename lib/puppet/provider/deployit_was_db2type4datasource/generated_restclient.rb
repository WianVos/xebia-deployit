...
Puppet::Type.type(:deployit_was_db2type4datasource).provide(:generated_restclient, :parent => Puppet::Provider::General_restclient) do
    ...
    def self.properties
      ...
      [  "jdbcProvider",  "password",  "jndiName",  "datasourceHelperClassname",  "serverName",  "username",  "description",  "databaseName",  ]
