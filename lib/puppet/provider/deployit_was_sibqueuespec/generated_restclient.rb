...
Puppet::Type.type(:deployit_was_sibqueuespec).provide(:generated_restclient, :parent => Puppet::Provider::General_restclient) do
    ...
    def self.properties
      ...
      [  "busName",  "description",  "deliveryMode",  "timeToLive",  "jndiName",  ]
