...
Puppet::Type.type(:deployit_overthere_sshjumpstation).provide(:generated_restclient, :parent => Puppet::Provider::General_restclient) do
    ...
    def self.properties
      ...
      [  "username",  "password",  "address",  "privateKeyFile",  "passphrase",  ]
