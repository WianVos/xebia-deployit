...
Puppet::Type.type(:deployit_was_oracledatasource).provide(:generated_restclient, :parent => Puppet::Provider::General_restclient) do
    ...
    def self.properties
      ...
      [  "datasourceHelperClassname",  "username",  "description",  "password",  "URL",  "jdbcProvider",  "jndiName",  ]
