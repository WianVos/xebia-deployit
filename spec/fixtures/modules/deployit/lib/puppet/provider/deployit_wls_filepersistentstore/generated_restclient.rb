...
Puppet::Type.type(:deployit_wls_filepersistentstore).provide(:generated_restclient, :parent => Puppet::Provider::General_restclient) do
    ...
    def self.properties
      ...
      [  "directory",  "targetRestartPolicy",  "synchronousWritePolicy",  ]
    
    end

    def self.parent
    
      [  "wls.Server",  "core.Directory",  ]
    
    end

    def self.autorequires
    
      [  "deployit_wls_server",  "deployit_core_directory",  ]
