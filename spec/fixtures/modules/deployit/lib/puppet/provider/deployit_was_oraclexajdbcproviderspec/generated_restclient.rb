...
Puppet::Type.type(:deployit_was_oraclexajdbcproviderspec).provide(:generated_restclient, :parent => Puppet::Provider::General_restclient) do
    ...
    def self.properties
      ...
      [  "implementationClassName",  "isolatedClassLoader",  "nativepath",  "classpath",  "xa",  "description",  "providerType",  ]
