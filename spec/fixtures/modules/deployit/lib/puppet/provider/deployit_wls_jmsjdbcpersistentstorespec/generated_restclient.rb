...
Puppet::Type.type(:deployit_wls_jmsjdbcpersistentstorespec).provide(:generated_restclient, :parent => Puppet::Provider::General_restclient) do
    ...
    def self.properties
      ...
      [  "restartTarget",  "prefixName",  "targetRestartPolicy",  ]
