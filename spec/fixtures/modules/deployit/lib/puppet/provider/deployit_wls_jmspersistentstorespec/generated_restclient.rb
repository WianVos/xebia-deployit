...
Puppet::Type.type(:deployit_wls_jmspersistentstorespec).provide(:generated_restclient, :parent => Puppet::Provider::General_restclient) do
    ...
    def self.properties
      ...
      [  "restartTarget",  "targetRestartPolicy",  ]
