...
Puppet::Type.type(:deployit_trigger_emailnotification).provide(:generated_restclient, :parent => Puppet::Provider::General_restclient) do
    ...
    def self.properties
      ...
      [  "body",  "fromAddress",  "subject",  "bodyTemplatePath",  ]
