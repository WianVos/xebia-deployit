Puppet::Type.newtype(:deployit_wls_filepersistentstorespec ) do

      # this type is generated with genres.rb
      # generated for deployit 3.8.5

      desc 'adds a deployit_wls_filepersistentstorespec ci to a remote deployit server'

      ensurable do

        desc 'deployit deployit_wls_filepersistentstorespec resource state'
      ...
      newparam(:id, :namevar => true) do
        desc 'deployit_wls_filepersistentstorespec id (full path required)'
