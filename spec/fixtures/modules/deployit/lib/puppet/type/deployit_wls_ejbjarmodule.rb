Puppet::Type.newtype(:deployit_wls_ejbjarmodule ) do

      # this type is generated with genres.rb
      # generated for deployit 3.8.5

      desc 'adds a deployit_wls_ejbjarmodule ci to a remote deployit server'

      ensurable do

        desc 'deployit deployit_wls_ejbjarmodule resource state'
      ...
      newparam(:id, :namevar => true) do
        desc 'deployit_wls_ejbjarmodule id (full path required)'
