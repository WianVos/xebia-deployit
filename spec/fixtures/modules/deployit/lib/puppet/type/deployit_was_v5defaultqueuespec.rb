Puppet::Type.newtype(:deployit_was_v5defaultqueuespec ) do

      # this type is generated with genres.rb
      # generated for deployit 3.8.5

      desc 'adds a deployit_was_v5defaultqueuespec ci to a remote deployit server'

      ensurable do

        desc 'deployit deployit_was_v5defaultqueuespec resource state'
      ...
      newparam(:id, :namevar => true) do
        desc 'deployit_was_v5defaultqueuespec id (full path required)'
