Puppet::Type.newtype(:deployit_overthere_localhost ) do

      # this type is generated with genres.rb
      # generated for deployit 3.8.5

      desc 'adds a deployit_overthere_localhost ci to a remote deployit server'

      ensurable do

        desc 'deployit deployit_overthere_localhost resource state'
      ...
      newparam(:id, :namevar => true) do
        desc 'deployit_overthere_localhost id (full path required)'
