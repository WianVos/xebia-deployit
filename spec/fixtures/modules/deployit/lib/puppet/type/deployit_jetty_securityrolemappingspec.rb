Puppet::Type.newtype(:deployit_jetty_securityrolemappingspec ) do

      # this type is generated with genres.rb
      # generated for deployit 3.8.5

      desc 'adds a deployit_jetty_securityrolemappingspec ci to a remote deployit server'

      ensurable do

        desc 'deployit deployit_jetty_securityrolemappingspec resource state'
      ...
      newparam(:id, :namevar => true) do
        desc 'deployit_jetty_securityrolemappingspec id (full path required)'
      ...
      newproperty(:securityrole , :array_matching => :all) do
