Puppet::Type.newtype(:deployit_was_v5defaulttopicspec ) do

      # this type is generated with genres.rb
      # generated for deployit 3.8.5

      desc 'adds a deployit_was_v5defaulttopicspec ci to a remote deployit server'

      ensurable do

        desc 'deployit deployit_was_v5defaulttopicspec resource state'
      ...
      newparam(:id, :namevar => true) do
        desc 'deployit_was_v5defaulttopicspec id (full path required)'
