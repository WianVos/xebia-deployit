Puppet::Type.newtype(:deployit_was_v5defaulttopicconnectionfactory ) do

      # this type is generated with genres.rb
      # generated for deployit 3.8.5

      desc 'adds a deployit_was_v5defaulttopicconnectionfactory ci to a remote deployit server'

      ensurable do

        desc 'deployit deployit_was_v5defaulttopicconnectionfactory resource state'
      ...
      newparam(:id, :namevar => true) do
        desc 'deployit_was_v5defaulttopicconnectionfactory id (full path required)'
