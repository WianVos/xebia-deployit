Puppet::Type.newtype(:deployit_overthere_sshjumpstation ) do

      # this type is generated with genres.rb
      # generated for deployit 3.8.5

      desc 'adds a deployit_overthere_sshjumpstation ci to a remote deployit server'

      ensurable do

        desc 'deployit deployit_overthere_sshjumpstation resource state'
      ...
      newparam(:id, :namevar => true) do
        desc 'deployit_overthere_sshjumpstation id (full path required)'
