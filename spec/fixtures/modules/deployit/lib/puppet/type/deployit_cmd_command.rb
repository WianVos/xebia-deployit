Puppet::Type.newtype(:deployit_cmd_command ) do

      # this type is generated with genres.rb
      # generated for deployit 3.8.5

      desc 'adds a deployit_cmd_command ci to a remote deployit server'

      ensurable do

        desc 'deployit deployit_cmd_command resource state'
      ...
      newparam(:id, :namevar => true) do
        desc 'deployit_cmd_command id (full path required)'
