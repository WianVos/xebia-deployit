Puppet::Type.newtype(:deployit_wls_topic ) do

      # this type is generated with genres.rb
      # generated for deployit 3.8.5

      desc 'adds a deployit_wls_topic ci to a remote deployit server'

      ensurable do

        desc 'deployit deployit_wls_topic resource state'
      ...
      newparam(:id, :namevar => true) do
        desc 'deployit_wls_topic id (full path required)'
