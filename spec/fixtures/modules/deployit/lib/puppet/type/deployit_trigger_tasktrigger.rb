Puppet::Type.newtype(:deployit_trigger_tasktrigger ) do

      # this type is generated with genres.rb
      # generated for deployit 3.8.5

      desc 'adds a deployit_trigger_tasktrigger ci to a remote deployit server'

      ensurable do

        desc 'deployit deployit_trigger_tasktrigger resource state'
      ...
      newparam(:id, :namevar => true) do
        desc 'deployit_trigger_tasktrigger id (full path required)'
