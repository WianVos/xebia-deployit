Puppet::Type.newtype(:deployit_was_earmodule ) do

      # this type is generated with genres.rb
      # generated for deployit 3.8.5

      desc 'adds a deployit_was_earmodule ci to a remote deployit server'

      ensurable do

        desc 'deployit deployit_was_earmodule resource state'
      ...
      newparam(:id, :namevar => true) do
        desc 'deployit_was_earmodule id (full path required)'
