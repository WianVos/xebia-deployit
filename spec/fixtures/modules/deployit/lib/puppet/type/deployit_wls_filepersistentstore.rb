Puppet::Type.newtype(:deployit_wls_filepersistentstore ) do

      # this type is generated with genres.rb
      # generated for deployit 3.8.5

      desc 'adds a deployit_wls_filepersistentstore ci to a remote deployit server'

      ensurable do

        desc 'deployit deployit_wls_filepersistentstore resource state'
      ...
      newparam(:id, :namevar => true) do
        desc 'deployit_wls_filepersistentstore id (full path required)'
      ...
      [ "deployit_wls_server",  "deployit_core_directory", ].each {|c|
