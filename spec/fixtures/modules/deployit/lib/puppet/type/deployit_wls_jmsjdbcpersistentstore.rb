Puppet::Type.newtype(:deployit_wls_jmsjdbcpersistentstore ) do

      # this type is generated with genres.rb
      # generated for deployit 3.8.5

      desc 'adds a deployit_wls_jmsjdbcpersistentstore ci to a remote deployit server'

      ensurable do

        desc 'deployit deployit_wls_jmsjdbcpersistentstore resource state'
      ...
      newparam(:id, :namevar => true) do
        desc 'deployit_wls_jmsjdbcpersistentstore id (full path required)'
      ...
      newproperty(:prefixname) do
          ...
          validate do |value|
            unless value != 'unset'
              fail('prefixname needs to be set')
            end
          end
