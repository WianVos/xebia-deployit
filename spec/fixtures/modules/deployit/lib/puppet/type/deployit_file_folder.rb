Puppet::Type.newtype(:deployit_file_folder ) do

      # this type is generated with genres.rb
      # generated for deployit 3.8.5

      desc 'adds a deployit_file_folder ci to a remote deployit server'

      ensurable do

        desc 'deployit deployit_file_folder resource state'
      ...
      newparam(:id, :namevar => true) do
        desc 'deployit_file_folder id (full path required)'
